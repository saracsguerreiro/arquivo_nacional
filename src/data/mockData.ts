...
export const govPosts = [
  ...
  },
  {
    ...
    ministry: "Saúde",
    content: "Alerta: Detetados 12 novos casos de cólera na Província de Sofala. Equipas de resposta rápida já mobilizadas. Coordenação com a Defesa Civil em curso. Atualização às 18h.",
    likes: 22,
    comments: 11,
    liked: false,
  },
